...
export function ChampionBox({ champInfo }: IChampionBoxProps) {
  return (
    <div style={{ backgroundColor: champInfo.color }} className={`relative flex h-[100px] w-[165px] rounded-[10px] `}>
      <Image
      ...
      <div
        style={{
          backgroundImage: `url(http://ddragon.leagueoflegends.com/cdn/13.18.1/img/champion/${champInfo.id}.png)`,
